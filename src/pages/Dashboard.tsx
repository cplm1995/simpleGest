  ...
  return (
    <>
      <div className="container-sm mt-1 dashboard-background">
        ...
        <div className="row text-center g-3">
            ...
            <div className="card shadow-sm" style={{ border: "none" }}>
              <div className="card-body">
                <h5 className="card-title text-muted">
                  <FaBox style={{ color: "gray", marginRight: 10 }} /> Artículos
                </h5>
                <p className="card-text fs-4 fw-bold text-muted">
          ...
          <div className="col-md-3 mb-3">
            <div className="card shadow-sm" style={{ border: "none" }}>
              <div className="card-body">
                <h5 className="card-title text-muted">
                  <FaRotate style={{ color: "gray", marginRight: 10 }} />{" "}
          ...
          <div className="col-md-3 mb-3">
            <div className="card shadow-sm" style={{ border: "none" }}>
              <div className="card-body">
                <h5 className="card-title text-muted">
                  <FaCheckToSlot style={{ color: "gray", marginRight: 10 }} />{" "}
        ...
        <div className="mt-4">
          <h4>
            <FaChartLine style={{ marginRight: 10 }} /> Artículos próximos a
            agotarse
          </h4>
          {bajoStock.length === 0 ? (
            <p className="text-success">
              <FaCheckToSlot style={{ fontSize: 25, marginRight: 10 }} />
              ...
              <tbody>
                {bajoStock.map((art) => (
                  <tr
                    key={art._id}
                    className={
                      art.stock === 0 ? "table-danger" : "table-warning"
                    }
                  >
                    <td>
                      <strong>{1 + bajoStock.indexOf(art)}</strong>
                    </td>
                    <td>
                      {art.nombreArticulo} -{" "}
